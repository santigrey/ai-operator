...
- Control Plane: Server 3 (192.168.1.10) — FastAPI :8000, PostgreSQL + pgvector, MCP server :8001, nginx HTTPS :443
...
- Learns from approve/reject decisions (feedback loop → user_profile)
...
- Voice interface: mic → Whisper STT → Claude → ElevenLabs TTS → audio playback
...
- CC poller: /Users/jes/bin/cc_poller.py (Mac mini) — launchd com.ascension.cc-poller
...
- Week of 3/28: Lirio ✅, Wolters Kluwer ✅, Cohere ✅ (3 minimum met)
...
1. Image recognition — webcam → Claude vision API
...
"Paco — Day 41. Image recognition: add webcam capture to the dashboard so Alexandra can see me. Then 3 job applications."
